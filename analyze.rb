...
puts contributors_per_main_languages
...
puts Hash[main_languages_per_contributors.sort] # 名前順
puts Hash[main_languages_per_contributors.sort { |a, b| b[1].size <=> a[1].size} ] # 主要言語数順
